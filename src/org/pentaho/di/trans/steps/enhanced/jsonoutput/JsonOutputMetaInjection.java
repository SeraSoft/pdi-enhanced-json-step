...
public class JsonOutputMetaInjection implements StepMetaInjectionInterface {
    ...
    private enum Entry {
        ...
        OPERATION(ValueMetaInterface.TYPE_STRING, "The operation to perform (Output Value, Write to File, Output value and write to file)"),
        JSON_BLOC_NAME(ValueMetaInterface.TYPE_STRING, "The name of the Json Bloc"),
        BLOC_KEY_NAME(ValueMetaInterface.TYPE_STRING, "The field name to be considered as key for a specific bloc of data"),
    ...
    public List<StepInjectionMetaEntry> getStepInjectionMetadataEntries() throws KettleException {
        ...
        Entry[] topEntries =
                new Entry[]{
                        Entry.OPERATION, Entry.JSON_BLOC_NAME, Entry.BLOC_KEY_NAME, Entry.NR_ROWS_IN_BLOC, Entry.OUTPUT_VALUE,
        ...
        for (StepInjectionMetaEntry lookFields : all) {
            ...
            switch (fieldsEntry) {
                ...
                case OPERATION:
                    ...
                    break;
                case BLOC_KEY_NAME:
                    meta.setBlockKeyName(lookValue);
                    break;
                case JSON_BLOC_NAME:
